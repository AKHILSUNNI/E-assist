...
def vm():
    os.system('Gesture_Controller.py')
def tts():
    os.system('text-to-speech.py')
def sts():
    os.system('speech-to-sign.py')
def slr():
    os.system('inference_classifier.py')

a = Button(top, text="Gesture controlled virtual mouse", fg="black", bg="#637CED", activeforeground="black", activebackground="#87b9fa", pady=15,width=30,command=vm)
...
d = Button(top, text="Sign language recognition",fg="black", bg="#637CED", activeforeground="black", activebackground="#87b9fa", pady=15,width=30,command=slr)
a['font'] = myFont
b['font'] = myFont
c['font'] = myFont
d['font'] = myFont
